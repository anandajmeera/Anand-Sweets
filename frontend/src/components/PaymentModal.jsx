    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-fadeIn">
            <div className="bg-white rounded-2xl shadow-2xl p-8 w-96 transform transition-all scale-100">
                ...
                <p className="mb-6 text-xl font-extrabold text-right">Total: ₹{price}</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-3 mt-6">
                        ...
                        <button type="submit" className="px-6 py-2 bg-green-500 text-white rounded-lg font-bold hover:bg-green-600 shadow-md">Pay Now</button>
                    </div>
                </form>
            </div>
        </div>
